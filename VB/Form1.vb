...
Namespace ChartManualReport
    ...
    Public Partial Class Form1
        ...
        Private Sub simpleButton1_Click(ByVal sender As Object, ByVal e As EventArgs)
            ...
            AddHandler link.BeforeCreateAreas, New EventHandler(AddressOf link_BeforeCreateAreas)
            AddHandler link.CreateDetailArea, New CreateAreaEventHandler(AddressOf link_CreateDetailArea)
        ...
        Private Sub printingSystem1_AfterMarginsChange(ByVal sender As Object, ByVal e As MarginsChangeEventArgs)
            RecalcSize()
            link.CreateDocument()
        End Sub

        Private Sub printingSystem1_PageSettingsChanged(ByVal sender As Object, ByVal e As EventArgs)
            RecalcSize()
            link.CreateDocument()
        End Sub
